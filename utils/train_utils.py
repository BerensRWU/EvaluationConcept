...
def save_checkpoint(checkpoints_dir, saved_fn, model_state_dict, utils_state_dict, epoch, p_str):
    """Save checkpoint every epoch only is best model or after every checkpoint_freq epoch"""
    if epoch:
        model_save_path = os.path.join(checkpoints_dir, saved_fn, f'Model_{p_str}_ComplexYOLO_epoch_{epoch}.pth')
        #utils_save_path = os.path.join(checkpoints_dir, saved_fn, f'Utils_ComplexYOLO_epoch_{epoch}.pth')
        ...
        print(f'save a checkpoint at {model_save_path}')
    else:
        model_save_path = os.path.join(checkpoints_dir, saved_fn, f'Model_{p_str}_ComplexYOLO.pth')
